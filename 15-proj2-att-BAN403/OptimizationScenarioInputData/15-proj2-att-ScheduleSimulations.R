...
# save simulations
# write_xlsx(InputPatients, "15-proj2-att-OptimizationPatientInput.xlsx")
# write_xlsx(InputSchedule, "15-proj2-att-OptimizationScheduleInput.xlsx")

write.table(InputPatients, "15-proj2-att-OptimizationPatientInput.txt", sep = "\t", row.names = FALSE)
write.table(InputSchedule, "15-proj2-att-OptimizationScheduleInput.txt", sep = "\t", row.names = FALSE)
